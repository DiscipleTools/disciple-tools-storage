...
class Disciple_Tools_Media_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = '' ) {
        if ( $post_type === 'contacts' || $post_type === 'media' ){
            $tiles['disciple_tools_media'] = [ 'label' => __( 'Media', 'disciple-tools-media' ) ];
            $tiles['a_beautiful_tile'] = [ 'label' => __( 'A Beautiful Tile', 'disciple-tools-media' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = '' ) {
        ...
        if ( $post_type === 'contacts' || $post_type === 'media' ){
             ...
             */
            $fields['disciple_tools_media_text'] = [
                'name'        => __( 'Text', 'disciple-tools-media' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-media' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_media',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields['disciple_tools_media_multiselect'] = [
                'name' => __( 'Multiselect', 'disciple-tools-media' ),
                'default' => [
                    'one' => [ 'label' => __( 'One', 'disciple-tools-media' ) ],
                    'two' => [ 'label' => __( 'Two', 'disciple-tools-media' ) ],
                    'three' => [ 'label' => __( 'Three', 'disciple-tools-media' ) ],
                    'four' => [ 'label' => __( 'Four', 'disciple-tools-media' ) ],
                ],
                'tile' => 'disciple_tools_media',
                'type' => 'multi_select',
                'hidden' => false,
             ...
             */
            $fields['disciple_tools_media_keyselect'] = [
                'name' => 'Key Select',
                'type' => 'key_select',
                'tile' => 'disciple_tools_media',
                'default' => [
                    'first'   => [
                        'label' => _x( 'First', 'Key Select Label', 'disciple-tools-media' ),
                        'description' => _x( 'First Key Description', 'Training Status field description', 'disciple-tools-media' ),
                        'color' => '#ff9800'
                    ],
                    'second'   => [
                        'label' => _x( 'Second', 'Key Select Label', 'disciple-tools-media' ),
                        'description' => _x( 'Second Key Description', 'Training Status field description', 'disciple-tools-media' ),
                        'color' => '#4CAF50'
                    ],
                    'third'   => [
                        'label' => _x( 'Third', 'Key Select Label', 'disciple-tools-media' ),
                        'description' => _x( 'Third Key Description', 'Training Status field description', 'disciple-tools-media' ),
                        'color' => '#366184'
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ...
            //test fields
            $fields['number_test'] = [
                'name'        => __( 'Number field', 'disciple-tools-media' ),
                'type'        => 'number',
                'default'     => 0,
            ...
            $fields['number_test_private'] = [
                'name'        => __( 'Number field private', 'disciple-tools-media' ),
                'type'        => 'number',
                'default'     => 0,
                'tile'        => 'a_beautiful_tile',
                'private'     => true,
            ...
            $fields['contact_communication_channel_test'] = [
                'name'        => __( 'Communication Channel', 'disciple-tools-media' ),
            ...
            $fields['user_select_test'] = [
                'name'        => __( 'User Select', 'disciple-tools-media' ),
                'type'        => 'user_select',
                'tile'        => 'a_beautiful_tile'
            ];
            $fields['array_test'] = [
                'name'        => __( 'Array', 'disciple-tools-media' ),
                'type'        => 'array',
                'tile'        => 'a_beautiful_tile'
            ];
            ...
            $fields['date_test'] = [
                'name'        => __( ' Date Field', 'disciple-tools-media' ),
                'description' => '',
                'type'        => 'date',
                'default'     => '',
                'tile' => 'a_beautiful_tile'
            ...
            $fields['boolean_test'] = [
                'name'        => __( 'Boolean', 'disciple-tools-media' ),
                'type'        => 'boolean',
                'default'     => false,
            ];
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === 'contacts' || $post_type === 'media' ) && $section === 'disciple_tools_media' ){
            /**
...
Disciple_Tools_Media_Tile::instance();
